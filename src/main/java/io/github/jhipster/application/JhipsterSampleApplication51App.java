...
public class JhipsterSampleApplication51App {

    private static final Logger log = LoggerFactory.getLogger(JhipsterSampleApplication51App.class);

    private final Environment env;

    public JhipsterSampleApplication51App(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterSampleApplication51.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterSampleApplication51App.class);
